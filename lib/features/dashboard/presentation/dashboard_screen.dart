      ...
      children: [
        ...
        SizedBox(
          ...
          child: StatCard(
            ...
            value: '${stats.upcomingMatchCount}',
        ...
        SizedBox(
          ...
          child: StatCard(
            ...
            value: '${stats.activeTournamentCount}',
                ...
                child: Card(
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        Text(
                          dateFmt.format(match.datetime.toLocal()),
                          style: const TextStyle(
                            fontSize: 11,
                  ...
                  ListTile(
                    ...
                    leading: Container(
                      ...
                      child: Icon(iconData, size: 16,
                          color: n.read ? AppColors.textSecondary : AppColors.accent),
                    ),
                    title: Text(n.title,
                        style: TextStyle(
                          fontSize: 13,
